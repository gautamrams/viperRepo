 ...
 *            - Added changes to make CHyperlink1 compatible with UNICODE
 ...
 */
COLORREF CHyperlink1::g_crLinkColor     = RGB(  0,   0, 255);   // Blue;
COLORREF CHyperlink1::g_crVisitedColor  = RGB( 128,  0, 128);   // Purple;
HCURSOR  CHyperlink1::g_hLinkCursor     = NULL;
HFONT    CHyperlink1::g_UnderlineFont   = NULL;
int      CHyperlink1::g_counter         = 0;
...
/*
 * Function CHyperlink1::ConvertStaticToHyperlink
 */
BOOL CHyperlink1::ConvertStaticToHyperlink(HWND hwndCtl, LPCTSTR strURL)
{
    if( !(setURL(strURL)) )
		return FALSE;
 ...
 * Function CHyperlink1::ConvertStaticToHyperlink
 */
BOOL CHyperlink1::ConvertStaticToHyperlink(HWND hwndParent, UINT uiCtlId,
										  LPCTSTR strURL)
{
...
/*
 * Function CHyperlink1::setURL
 */
BOOL CHyperlink1::setURL(LPCTSTR strURL)
{
	if( m_strURL )
	{
		delete [] m_strURL;
...
/*
 * Function CHyperlink1::_HyperlinkParentProc
 */
LRESULT CALLBACK CHyperlink1::_HyperlinkParentProc(HWND hwnd, UINT message,
	...
	case WM_CTLCOLORSTATIC:
		{
			...
			CHyperlink1 *pHyperLink = (CHyperlink1 *)GetProp(hwndCtl,
				                                           PROP_OBJECT_PTR);
			...
			if(pHyperLink)
			{
				...
				if (!pHyperLink->m_bVisited)
				{
					...
					// optimization
					SetTextColor(hdc, CHyperlink1::g_crLinkColor);
				}
				else
				{
					SetTextColor(hdc, CHyperlink1::g_crVisitedColor);
				}
				return lr;
			}
			break;
...
/*
 * Function CHyperlink1::Navigate
 */
inline void CHyperlink1::Navigate(void)
{
	if(wcscmp(m_strURL,_T(""))==0) return;
...
/*
 * Function CHyperlink1::DrawFocusRect
 */
inline void CHyperlink1::DrawFocusRect(HWND hwnd)
{
...
/*
 * Function CHyperlink1::_HyperlinkProc
 *
 ...
 *       as expected.
 */
LRESULT CALLBACK CHyperlink1::_HyperlinkProc(HWND hwnd, UINT message,
		                                   WPARAM wParam, LPARAM lParam)
{
	CHyperlink1 *pHyperLink = (CHyperlink1 *)GetProp(hwnd, PROP_OBJECT_PTR);
	...
	case WM_MOUSEMOVE:
		{
			...
			else
			{
				...
				SendMessage(hwnd, WM_SETFONT,
					        (WPARAM)CHyperlink1::g_UnderlineFont, FALSE);
	...
	case WM_SETCURSOR:
		{
			SetCursor(CHyperlink1::g_hLinkCursor);
			return TRUE;
		}
	...
	case WM_KILLFOCUS:
		{
			...
			CHyperlink1::DrawFocusRect(hwnd);
			return 0;
		}
	case WM_DESTROY:
		{
...
/*
 * Function CHyperlink1::createUnderlineFont
 */
void CHyperlink1::createUnderlineFont(void)
{
	LOGFONT lf;
...
/*
 * Function CHyperlink1::createLinkCursor
 */
void CHyperlink1::createLinkCursor(void)
{
