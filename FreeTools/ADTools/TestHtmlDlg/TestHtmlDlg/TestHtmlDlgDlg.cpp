...
BOOL CTestHtmlDlgDlg::OnInitDialog()
{
	...
	temp="";
	temp=imagepath;
	temp.Append(_T("./..//images//top_band.gif"));
	m_TopBand.Init(temp);			
	...
	m_TopLink.ConvertStaticToHyperlink(GetSafeHwnd(),IDC_LOGO,L"http://www.manageengine.com/products/ad-manager/index.html");
...
HRESULT CTestHtmlDlgDlg::OnHelp(IHTMLElement *pElement)
{
	...
	tmpstr.Append(L"help\\index.html");
...
{
ShellExecute(NULL,L"Open",L"http://www.manageengine.com/products/free-windows-active-directory-tools/free-active-directory-tools-index.html",NULL,NULL,SW_SHOWNORMAL);
return S_OK;
}
HRESULT CTestHtmlDlgDlg::OnA2(IHTMLElement *pElement)
{
ShellExecute(NULL,L"Open",L"http://forums.manageengine.com?ftid=49000002687179",NULL,NULL,SW_SHOWNORMAL);
return S_OK;
}
HRESULT CTestHtmlDlgDlg::OnA3(IHTMLElement *pElement)
{
ShellExecute(NULL,L"Open",L"http://www.manageengine.com/products/free-windows-active-directory-tools/support.html",NULL,NULL,SW_SHOWNORMAL);
return S_OK;
}