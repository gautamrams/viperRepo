...
#ifndef _WIN32_WINNT			// Allow use of features specific to IE 4.0 or later.
...
extern wchar_t *ldappathptr,ldappath2[300];
extern BSTR Username,Password;
extern CString selDC;
extern int selCnt,timer;
