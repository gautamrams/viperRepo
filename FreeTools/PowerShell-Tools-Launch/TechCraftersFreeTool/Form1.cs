...
namespace FreeTool
{
    ...
    public partial class Form1 : Form
    {
       ...
       /*private void linkLabel14_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        ...
        {
            Process.Start("IExplore.exe", "http://www.techcrafters.com/");
        }

        private void pictureBox8_Click(object sender, EventArgs e)
        {
            Process.Start("IExplore.exe", "http://www.techcrafters.com/blogs-2");
        }

        private void pictureBox10_Click(object sender, EventArgs e)
        {
            Process.Start("IExplore.exe", "http://www.techcrafters.com/ask-questions");
        }

        private void pictureBox11_Click(object sender, EventArgs e)
        {
            Process.Start("IExplore.exe", path + "./../help/techcraftersindex.html");
        }
